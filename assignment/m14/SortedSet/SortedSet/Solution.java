...
class Set {
    ...
    /**
     * {This Adds Single item to the set }.
     *
     * @param      item  The item
     */
    ...
    /**
     * {This Adds array of elements to set }.
     *
     * @param      item   The item
     */
     ...
     * @return     { String }.
     */
    public String converttostring(final int[] sample, final int l) {
        String st = new String("{");
        int i = 0;
        for (i = 0; i < l - 1; i++) {
